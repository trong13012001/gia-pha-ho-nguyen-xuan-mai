                ...
                <main className="flex-1 flex flex-col items-center justify-center p-4">
                    <div className="max-w-md w-full text-center bg-white p-6 sm:p-8 rounded-xl sm:rounded-2xl shadow-sm border border-stone-200">
                        ...
                        <p className="text-stone-600">
                            Tài khoản của bạn đã được đăng ký thành công. Tuy
                            nhiên, hệ thống yêu cầu Quản trị viên kích hoạt tài
                            khoản của bạn trước khi bạn có thể xem các thông tin
                            gia đình.
                        </p>
                        <p className="text-stone-500 text-sm mt-4 italic">
                            Vui lòng liên hệ lại với người quản trị dòng họ để
                            được cấp quyền sớm nhất.
                        </p>
                    </div>
                </main>
            </div>
